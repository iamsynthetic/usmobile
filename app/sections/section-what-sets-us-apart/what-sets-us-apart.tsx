...
export default function WhatSetsUsApartSection({ className }: Props) {
  ...
  //   template2 = (
  //     <div className="flex flex-col px-4 xs:py-6">
  ...
  //             className="sectionbodytxt xs:text-[18px] md:text-[20px] max-w-[500px] leading-tight"
  //           >
  //             We do the essentials (and way more)
  //             <br />
  //             better than the rest. See how we stack up!
  //           </p>
  //           <div className="flex flex-row w-full h-full mt-6">
  //             <div
  //               id="whatsetsusapart-trustpilotbg"
  //               className="flex flex-row bg-[#f2dcb3] rounded-lg xs:h-[100px] lg:h-[160px] w-[430px]"
  //             >
  //               <div
  ...
  //         </div>
  //       </div>
  //       <div className="w-full flex flex-col relative xs:mt-6">
  //         <div
  //           id="whatsetsusapart-videoimage"
  ...
  //               className={`${styles.tabbutton} thespeedbtn spacegrotesklight pr-6 mt-6`}
  //               onMouseEnter={() => {
  //                 navbuttonhover(
  //                   ".chevronspeed",
  //                   ".thespeedbtn",
  ...
  //               className={`${styles.tabbutton} thevsbtn spacegrotesklight pr-6 mt-6`}
  //               onMouseEnter={() => {
  ...
  //               className={`${styles.tabbutton} theunlimitedbtn spacegrotesklight pr-6 mt-6`}
  //               onMouseEnter={() => {
  //                 navbuttonhover(
  //                   ".chevronvs",
  //                   ".theunlimitedbtn",
