...
export default function PerksSection({ className }: Props) {
  ...
  //         >
  //           Choose from over 10 audio, streaming and gaming services for a $15 a
  //           month credit when you have 3 lines on Unlimited&nbsp;Premium.
  //         </p>
  ...
  //             />
  //           </div>
  //           <div className="flex flex-row w-full rounded-2xl xs:px-4 md:px-4 xl:px-8 bg-[#C7E2F3]">
  ...
  //                 </div>
  //                 <div id="perks-perk1-body" className="flex flex-row mt-3 ">
  //                   <div>
  ...
  //             />
  //           </div>
  //           <div className="flex flex-row w-full rounded-2xl xs:px-4 md:px-4 xl:px-8 xs:py-6 lg:py-0 xs:mt-6 lg:mt-0 bg-[#C7E2F3]">
  //             <div className="flex flex-row w-full m-auto">
  //               <div
  //                 id="perks-perk1-number"
  //                 className="flex w-20 spacegrotesk text-3xl"
